function chanakya_to_unicode(chanakya_text = "") {
  ...
  unicode_text =
    "आपके द्वारा हमें यूनीकोड में बदलने के लिए दिये गये शब्द Chanakya लिपि में नहीं हैं";
  var modified_substring = chanakya_text;
  var text_size = chanakya_text.length;
  var processed_text = "";
  var sthiti1 = 0;
  var sthiti2 = 0;
  var chale_chalo = 1;
  ...
  while (chale_chalo == 1) {
    ...
    if (sthiti2 < text_size - max_text_size) {
      ...
      while (chanakya_text.charAt(sthiti2) != " ") {
        sthiti2--;
      }
    } else {
      sthiti2 = text_size;
    ...
    var modified_substring = chanakya_text.substring(sthiti1, sthiti2);
    Replace_Symbols();
    processed_text += modified_substring;
    unicode_text = processed_text;
  }
  return unicode_text;
...
function unicode_to_chankya(unicode_text = "") {
  var array_one = new Array(
    "‘",
    "’",
    "“",
  ...
  Replace_Symbols();
  legacy_text = modified_substring;
  return legacy_text;
  function Replace_Symbols() {
    if (modified_substring != "") {
...
module.exports = { chanakya_to_unicode, unicode_to_chankya };
